    ...
    <div class="inner">
      <div class="sec-mv">
        <div class="cmt">
          ...
          <div class="cmt-box"><p>希望<span>の</span>地域<span>で</span>仕事<span>が見つかる！</span></p></div>
        </div>
        <div class="nurse-blk">
          <h2>
            <img src="<?php print get_template_directory_uri(); ?>/assets/img/img_heading_pc.png" alt="介護職専門の転職サイトを徹底比較！">
          </h2>
          <div class="nurse-img">
            <img src="<?php print get_template_directory_uri(); ?>/assets/img/img_nurse_pc.png" alt="介護職専門の転職サイトを徹底比較！">
          </div>
        </div>
        <div class="compare-blk">
          <ul class="compare-list">
            <li>
              <img src="<?php print get_template_directory_uri(); ?>/assets/img/img_point01_pc.png" alt="レアな非公開求人多数">
            </li>
            <li>
              <img src="<?php print get_template_directory_uri(); ?>/assets/img/img_point02_pc.png" alt="自宅から25分以内の求人">
            </li>
            <li>
              <img src="<?php print get_template_directory_uri(); ?>/assets/img/img_point03_pc.png" alt="年収450万以上の求人">
            </li>
          </ul>
        </div>
      </div>
                  ...
                  <li>
                    ...
                    <a href="<?php echo $top_url01; ?>">
                      <div class="txt">
                        <p>はじめての転職でも安心！</p>
                        <h2>20代</h2>
                        <p><span>の介護士さんに<br>オススメエージェントは</span>こちら</p>
                      </div>
                    </a>
                  </li>
                  <li>
    ...
    <div class="sec-recommended-agent">
      <div class="inner">
        ...
        <div class="agent-list">
          <?php if (have_posts()) : ?>
            <?php query_posts('posts_per_page=4&post_type=agent_list&order=DESC&paged='.$paged); ?>
              <?php while (have_posts()) : the_post(); 
