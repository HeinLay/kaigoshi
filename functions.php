...
function get_description()
{
	//記事ページ
	if (is_single() || is_page()) {
		$description = get_the_title() . '。' . 'あなたにピッタリの介護士専門の転職エージェントに出会える！介護士さんの転職やキャリアアップをお助けします。独自の調査に基づいた編集部オススメのエージェント情報をお届けします。';
	}
	//アーカイブ系ページ
	if (is_archive()) {
		...
		$description = single_cat_title('', false) . '一覧。' . 'あなたにピッタリの介護士専門の転職エージェントに出会える！介護士さんの転職やキャリアアップをお助けします。独自の調査に基づいた編集部オススメのエージェント情報をお届けします。';
	}
	//検索ページ
	if (is_search()) {
		$description = get_bloginfo('name') . 'の検索結果一覧。' . 'あなたにピッタリの介護士専門の転職エージェントに出会える！介護士さんの転職やキャリアアップをお助けします。独自の調査に基づいた編集部オススメのエージェント情報をお届けします。';
	}
	//404ページ
	if (is_404()) {
	...
	//top
	if (is_home()) {
		$description = 'あなたにピッタリの介護士専門の転職エージェントに出会える！介護士さんの転職やキャリアアップをお助けします。独自の調査に基づいた編集部オススメのエージェント情報をお届けします。';
	}
